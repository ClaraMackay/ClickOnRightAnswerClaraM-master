...
-- SOUND
-----------------------------------------------------------------------------------------
--the local variables for the sound effects
...
-- Function that transitions to the You Lose Screen
local function LoseScreenTransition( )        
    composer.gotoScene( "you_lose", {effect = "zoomInOutFade", time = 1000})
end 


-- Function that transitions to the You Win Screen
local function LoseScreenTransition( )        
...
-- Function that displays the text in the bottom right corner, 
-- and also goes to the "You Lose" screen when you get 3 questions wrong.
...
function scene:create( event )
    ...
    answerTextObject = display.newText("", display.contentWidth*.4, display.contentHeight*2/3, nil, 50 )
    wrongAnswer1TextObject = display.newText("", display.contentWidth*.3, display.contentHeight*2/3, nil, 50 )
    wrongAnswer2TextObject = display.newText("", display.contentWidth*.2, display.contentHeight*2/3, nil, 50 )
    wrongAnswer3TextObject = display.newText("", display.contentWidth*.2, display.contentHeight*2/3, nil, 50 )
